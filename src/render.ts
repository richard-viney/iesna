...
/**
 * Renders IESNA data into an HTML canvas. The entire canvas is rendered into by
 * this function. The distance parameter sets the distance from the plane of the
 * samples being taken.
 */
