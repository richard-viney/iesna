...
/**
 * Returns the light intensity in the IES volume at the given coordinate relative to the light. The
 * resulting intensity is found by bilinearly interpolating the nearby samples.
 */
export function sample({
  ...
  const d = iesData.photometricData.candela[horizontalIndex + 1][verticalIndex + 1];
